...
//        String redYText = "\u001B[34m";
        ...
        System.out.println("\u001B[34m"+"Welcome to Fashions - Your Ultimate Shopping Experience!" );

        Cart cart = new Cart();
        ArrayList<Product> electronics = new ArrayList<>();
        ArrayList<Product> electronics_Phone = new ArrayList<>();
        ArrayList<Product> electronics_Charger = new ArrayList<>();
